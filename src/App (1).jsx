...
Make this a world-class business plan that could actually secure funding from top-tier VCs or banks.`;
    ...
    try {
      // ============================================
      // FIXED: Now calling the serverless API route
      // instead of Anthropic API directly
      // ============================================
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="List your main direct competitors and what they offer"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="Who else competes for your customer's money?"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div>
              <label style={labelStyle}>Competitive Positioning *</label>
              <textarea
                name="competitivePositioning"
                value={formData.competitivePositioning}
                onChange={handleInputChange}
                placeholder="How do you position yourself vs competitors?"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="What makes it hard for others to copy you?"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="All ways you make money"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="Main costs: rent, payroll, etc."
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
        ...
        return (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              ...
              <div>
                <label style={labelStyle}>Customer Lifetime Value</label>
                <input
                  type="text"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="How do you convert leads?"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="Brand positioning and values"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="Who do you rely on?"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="Software, platforms, tools"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="Machinery, vehicles, computers"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="Office, warehouse, remote?"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="How you manage stock, fulfillment"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="Experience, expertise, achievements"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                placeholder="e.g., 3 founders, 5 employees"
                style={inputStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="Any advisors or mentors?"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="Key hires in next 12-24 months"
                style={textareaStyle}
                onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
              />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="Product dev, marketing, etc."
                  style={inputStyle}
                  onFocus={(e) => e.target.style.borderColor = '#FFD700'}
                  onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
                />
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Progress bar - only show on form pages */}
        {currentPage <= 11 && (
